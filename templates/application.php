...
<html lang="en">
  <head>
    <title>Greetings from a sample PHP app using Node.js for assets management!</title>
    <meta content='website' property='og:type'>
    <meta content='https://cdn.scalingo.com/homepage/assets/fb-33a6a93ddbf90bfdae57407481aa05a4.png' property='og:image'>
    <meta content="Deploying your own PHP/Node.js app on Scalingo is as easy as pie: JUST CLICK THIS BUTTON! It will be up in less than 2 minutes!" property='og:description'>
    <meta charset="utf-8">
  ...
  <body>
    <div class="container hero">
      ...
      <h1>Greetings from a sample PHP app <br/> using Node.js for assets management!</h1>
      <h2>
        <span style="display:block;"><span class="one-liner">Deploying your own PHP/Node.js app on Scalingo</span> is as easy as pie:</span>
        <a class="btn" href="https://my.scalingo.com/deploy?source=https://github.com/Scalingo/sample-php-nodejs">Just click this button!</a>
        <span style="display:block;">It will be up in less than 2 minutes!</span>
      </h2>
      <p>The code of this sample lives <a href="https://github.com/Scalingo/sample-php-nodejs">on GitHub</a>. You can find <a href="http://samples.scalingo.com">more samples here</a>.</p>
    </div>
    <footer>
      <div class="container">
        <p>
